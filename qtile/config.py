...
keys = [
    ...
    Key([mod, "shift"], "d", lazy.spawn(
        "rofi -show drun"), desc="App launcher"),
    ...
    Key([], "XF86MonBrightnessUp", lazy.spawn(
            "brightnessctl set +5%"), desc="Raise brightness level by 5%"),
    Key([], "XF86MonBrightnessDown", lazy.spawn(
            "brightnessctl set 5%-"), desc="Lower brightness level by 5%"),
    Key([], "XF86AudioRaiseVolume", lazy.spawn(
            "amixer sset Master 5%+"), desc="Raise volume level by 5%"),
    Key([], "XF86AudioLowerVolume", lazy.spawn(
            "amixer sset Master 5%-"), desc="Lower volume level by 5%"),
    Key([], "XF86AudioMute", lazy.spawn("amixer sset Master 1+ toggle"),
            desc="Mute or unmute volume level"),

    # Applications
    Key([mod, "shift"], "Return", lazy.spawn(
        "thunar"), desc="File manager"),
